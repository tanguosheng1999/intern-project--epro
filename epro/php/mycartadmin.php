...
$sqlcart = "SELECT * FROM tbl_admincarts WHERE admin_email = '$adminemail'";
...
$stmtqty = $conn->prepare("SELECT * FROM tbl_admincarts INNER JOIN tbl_customers ON tbl_admincarts.customer_id = tbl_customers.customer_id WHERE tbl_admincarts.admin_email = '$adminemail'");
$stmtqty->execute();
...
<body>
    ...
    <div class="w3-top">
        <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
            ...
            <div class="w3-right w3-padding-16" id = "carttotalida" >Cart (<?php echo $carttotal?>)</div>
            <div class="w3-center w3-padding-16">EPRO ESYSTEM</div>
        </div>
    </div>
    <div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
        <div class="w3-container w3-center"><p>Cart for <?php echo $admin_name?> </p></div><hr>
        <div class="w3-grid-template">
             ...
             $total_payable = 0.00;
                foreach ($rowsqty as $customers){
                    ...
                    <a href='mycartadmin.php?useremail=$useremail&customerid=$customerid&qty=$customer_qty&submit=remove' class='w3-btn w3-red w3-round'>-</a>
                    $customer_qty
                    <a href='mycartadmin.php?useremail=$useremail&customerid=$customerid&qty=$customer_qty&submit=add' class='w3-btn w3-green w3-round'>+</a><br>
                    <br>
        ...
        </b></p><a href='paymentadmin.php?email=$adminemail&amount=$total_payable' class='w3-button w3-round w3-blue'> Pay Now </a> </div>";
        ?>
