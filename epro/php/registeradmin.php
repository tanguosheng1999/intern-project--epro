...
if (isset($_POST['submit'])) {
    ...
    echo $sqlregister = "INSERT INTO `tbl_admins`(`admin_email`, `admin_password`, `admin_otp`, `admin_phone`, `admin_name`) VALUES ('$email','$password','$otp','$phone','$name')";
    try {
...
function sendMail($email,$otp){
    ...
    <p><button><a href ='https://eproesystem.com/esystem/epro/php/verifyaccountadmin.php?email=$email&otp=$otp'>Verify Here</a></button>";
      ...
      <div class="w3-row w3-card">
        ...
        <div class="w3-half w3-container">
          ...
          <form name="registerForm" class=""  action="registeradmin.php" method="post">
            ...
            <p><a href="loginadmin.php" style="text-decoration:none;">Already registered? Login here.</a><br>
