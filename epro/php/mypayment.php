   ...
   <body onload="loadCookies()">
      ...
      <div class="w3-top">
         <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
            ...
            <div class="w3-center w3-padding-16">Epro Esyetm</div>
         </div>
      </div>
          ...
          <div class="w3-grid-template">
               ...
               $count = 0;
                foreach ($rows as $payments){
                    ...
                    <div class='w3-button w3-blue w3-round w3-block'><a style='text-decoration: none;' href='https://eproesystem.com/esystem/epro/php/payment_details.php?receipt=$paymentreceipt'>Details</a></div>
                    </div></div>";
                }
